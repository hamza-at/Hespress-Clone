...
import {DataTamazight} from "./Data";

const Tamazight =(props) => {
    ...
    return (<div className="container main-content">
            <h3 className="title1 text-decoration-underline" >تمازيغت</h3>
            <div className="row" id="listing">
                <div className="col-12 col-md-7 col-lg-8 col-xl-9">
                    <Grid container spacing={1}>
                        <Grid container item spacing={3}>
                            <React.Fragment>
                        {DataTamazight.map((item,index)=> {
