...
import {DataSawtSoura} from "./Data";

const Sawtsoura =(props) => {
    ...
    return (<div className="container main-content">
            <h3 className="title1 text-decoration-underline" >صوت
                و صورة</h3>
