...
import Item from "../../assets/images/politiqueCardTest.jpg";
import {DataPolitics} from "./Data";
import handler from "../../utils/helpers";
console.log(<handler search_query="a"/>)
const Politics =(props) => {
    ...
    return (<div className="container main-content">
            <h3 className="title1 text-decoration-underline" >سياسة</h3>
            <div className="row" id="listing">
                <div className="col-12 col-md-7 col-lg-8 col-xl-9">
                    <Grid container spacing={1}>
                        <Grid container item spacing={3}>
                            <React.Fragment>
                        {DataPolitics.map((item,index)=> {
