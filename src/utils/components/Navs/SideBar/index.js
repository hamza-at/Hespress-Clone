...
export default ({ close }) => (
    <div className="menu ">
        ...
        <div className="p-2 social-nav  ">
            <a href="https://www.twitter.com/Hespress/" className="twitter-icon" rel="noopener" target="_blank" onClick={close}> twitter</a>
            <a href=" https://bit.ly/2nSBfHS" className="youtube-icon" rel="noopener" target="_blank" onClick={close}> ytb</a>
            <a href="https://www.instagram.com/hespress/" className="instagram-icon" rel="noopener" target="_blank" onClick={close}> ig</a>
            <a href="https://www.facebook.com/Hespress/" className="facebook-icon" rel="noopener" target="_blank" onClick={close}> fb</a>
        </div>
        </div>
        <ul>
